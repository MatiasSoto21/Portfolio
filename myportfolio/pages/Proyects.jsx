          ...
          <section className='flex flex-col md:flex-row lg:flex-row'>
            <div className='flex flex-col mx-2 mb-4 shadow-2xl shadow-black rounded-2xl md:mt-10 md:px-2  bg-cyan-800 hover:scale-105 duration-300'>
              ...
              <div className='text-xl flex justify-center gap-8 my-2 text-white'>
                <a rel="noreferrer" href='https://github.com/MatiasSoto21/HENRY-PI' target="_blank" className='hover:text-cyan-300'>
                  <AiFillGithub className='text-xl md:text-2xl lg:text-4xl'></AiFillGithub>
                </a>
                <a rel="noreferrer" href='https://henry-pi-ruby.vercel.app/' target="_blank" className='hover:text-cyan-300'>
            ...
            <div className='flex flex-col mx-2 mb-4 shadow-2xl shadow-black rounded-2xl md:mt-10 md:px-2  bg-cyan-800 hover:scale-105 duration-300'>
              <div className='text-white text-center flex flex-col items-center'>
                ...
                <p className='text-xs py-2 max-w-xs mx-auto md:text-base md:font-normal lg:text-lg lg:font-medium'>E-commerce Android App</p>
              ...
              <div className='text-xl flex justify-center gap-8 my-2 text-white'>
                <a rel="noreferrer" href='https://github.com/Leandro-Larrea/PF-Ecommerce' target="_blank" className='hover:text-cyan-300'>
                  <AiFillGithub className='text-xl md:text-2xl lg:text-4xl'></AiFillGithub>
                </a>
                <a rel="noreferrer" href='https://drive.google.com/file/d/1iv5c1CzGqt7dRl1hu2f1Js9pdxR31oTX/view' target="_blank" className='hover:text-cyan-300'>
